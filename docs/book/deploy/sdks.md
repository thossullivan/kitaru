...
{% hint style="info" %}
The TypeScript packages require Node `>=22.22.0 <23 || >=24 <25 || >=26 <27` and are versioned and released together. Install with `pnpm add @zenml-io/kitaru`; see [Installation](../getting-started/installation.md).
{% endhint %}
